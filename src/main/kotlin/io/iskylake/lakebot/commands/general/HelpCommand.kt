...
class HelpCommand : Command {
    ...
    override val description = "The command that sends LakeBot documentation"
    override fun invoke(event: MessageReceivedEvent, args: Array<String>) {
        if (args.isEmpty()) {
            val embed = buildEmbed {
                ...
                description {
                    "**[Support Server](https://discord.gg/QsTevwF)** \u2022 **[Invite Link](https://discordapp.com/api/oauth2/authorize?client_id=${event.selfUser.id}&permissions=${Immutable.PERMISSIONS}&scope=bot)** \u2022 **[GitHub Repository](https://github.com/ISkylakeS/LakeBot)**"
                }
                timestamp()
