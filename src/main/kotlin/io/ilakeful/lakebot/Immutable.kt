...
object Immutable {
    ...
    val VERSION = Version(1, 0, stability = Stability.BETA, unstable = 11)
    ...
    val PERSPECTIVE_API_KEY = System.getenv("PERSPECTIVE_API_KEY")!!
    ...
    val DEVELOPERS = longArrayOf(337643430903676928, 605859118615625729)
}